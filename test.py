...
from widgets.litmos_control_widget import LitmosControlPanel
...
def main():
    ...
    litmos_control_panel = LitmosControlPanel()
    ...
    tab_widget.addTab(litmos_control_panel, "LITMoS Control Panel")
